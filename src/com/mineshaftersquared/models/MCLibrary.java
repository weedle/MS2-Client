...
public class MCLibrary {
	...
	public List<SimpleOS> getRestrictedOperatingSystems() {
		return Collections.unmodifiableList(this.restrictedOperatingSystems);
	}
	 ...
	 * @return
	 */
	public String getDownloadName(SimpleOS os) {
