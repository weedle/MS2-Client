...
public class CompleteVersion implements Version {
	...
	public CompleteVersion(String id, Date releaseTime, Date updateTime, ReleaseType type, String mainClass,
	...
	public CompleteVersion(CompleteVersion version) {
		this(version.getId(), version.getReleaseTime(), version.getUpdatedTime(), version.getType(), version
				.getMainClass(), version.getMinecraftArguments());
	}

	public CompleteVersion(Version version, String mainClass, String minecraftArguments) {
		this(version.getId(), version.getReleaseTime(), version.getUpdatedTime(), version.getType(), mainClass,
				minecraftArguments);
	}
	...
	public Collection<File> getClassPath(SimpleOS os, File base) {
	...
	public Collection<String> getExtractFiles(SimpleOS os) {
		Collection<Library> libraries = this.getRelevantLibraries();
		Collection result = new ArrayList();
	...
	public Set<String> getRequiredFiles(SimpleOS os) {
	...
	public Set<Downloadable> getRequiredDownloadables(SimpleOS os, Proxy proxy, File targetDirectory,
			boolean ignoreLocalFiles) throws MalformedURLException {
		Set neededFiles = new HashSet();
	...
	public String toString() {
		return "CompleteVersion{id='" + this.id + '\'' + ", time=" + this.time + ", type=" + this.type + ", libraries="
				+ this.libraries + ", mainClass='" + this.mainClass + '\'' + ", minimumLauncherVersion="
