...
public class Library {
	...
	private Map<SimpleOS, String> natives;
	...
	public Library addNative(SimpleOS operatingSystem, String name) {
		if (operatingSystem == null/* || !operatingSystem.isSupported()*/) {
			throw new NullPointerException("Param 0 (SimpleOS operatingSystem) is null");
		}
		if ((name == null) || (name.length() == 0)) {
			throw new IllegalArgumentException("Cannot add native for null or empty name");
		}
		if (this.natives == null) {
			this.natives = new EnumMap(SimpleOS.class);
		}
